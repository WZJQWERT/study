...
public class ConstantFactory implements IConstantFactory {
    ...
    public String getDictName(Long dictId) {
        if(CoreUtil.isEmpty(dictId)){
            ...
            Dict dict = this.dictMapper.selectById(dictId);
            if(dict==null){
                return "";
            }else{
                return dict.getName();
    ...
    public String getDictsByName(String name, String code) {
        ...
        if(dictType==null){
            ...
            List<Dict> dicts = this.dictMapper.selectList(wrapper);
            for(Dict item: dicts){
    ...
    public String getDictNameByCode(String dictCode) {
        if(CoreUtil.isEmpty(dictCode)){
            ...
            Dict dict = this.dictMapper.selectOne(dictQueryWrapper);
            if(dict==null){
                return "";
            }else{
                return dict.getName();
    ...
    public List<Dict> findInDict(Long id) {
        if(CoreUtil.isEmpty(id)){
            ...
            QueryWrapper<Dict> wrapper = new QueryWrapper<>();
            List<Dict> dicts = this.dictMapper.selectList(wrapper.eq("pid",id));
    ...
    public List<Long> getParentDeptIds(Long deptId) {
        ...
        for (String s: split){
            parentDeptIds.add(Long.parseLong(StrUtil.removeSuffix(StrUtil.removePrefix(s,"["),"]")));
        }
    ...
    public String getSingleRoleName(Long roleId) {
        ...
        Role roleObj = this.roleMapper.selectById(roleId);
    ...
    public String getSingleRoleTip(Long roleId) {
        ...
        Role roleObj = this.roleMapper.selectById(roleId);
        if(CoreUtil.isNotEmpty(roleObj) && CoreUtil.isNotEmpty(roleObj.getDescription())){
    ...
    public String getMenuNames(String menuIds) {
        ...
        for (Long menuId : menus){
            ...
            if(CoreUtil.isNotEmpty(menu) && CoreUtil.isNotEmpty(menu.getName())){
