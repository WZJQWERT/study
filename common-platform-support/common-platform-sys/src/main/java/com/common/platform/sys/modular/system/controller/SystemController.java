...
public class SystemController extends BaseController {
    ...
    @ResponseBody
    public Object updateAvatar(@RequestParam("fileId") String fileId){
        if(CoreUtil.isEmpty(fileId)){
            throw new RequestEmptyException("请求头像为空");
        }
        this.fileInfoService.updateAvatar(fileId);
        return SUCCESS_TIP;
    }
    ...
    public ResponseData getUserInfo(){
        ...
        return ResponseData.success(this.userService.getUserInfo(loginUser.getId()));
    }
